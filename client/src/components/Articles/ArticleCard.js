...
const ArticleCard = ({ article, withImage = false, withContent = false }) => {
    ...
    return (
        <div className="flex flex-col p-4">
            ...
            {!withContent && <p className="py-2 text-gray-500">{article.description}</p>}

            {withContent && <p className="py-2 text-gray-500">{article.content}</p>}
